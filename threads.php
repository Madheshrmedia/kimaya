    ...
    <main>
        <div class="container" id="journey">
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    ...
                    <p>At Kimaya Clinique, our Threads treatment provides a non-surgical solution for lifting and
                        tightening the skin. </p>
                ...
                <div class="col-sm-6 col-md-6 padleft">
                    <img src="./image/th-1.webp" alt="photolaser">
                </div>
            </div>
        </div>
        <!-- --------------------------- -->
            ...
            <div class="row" id="cardrowlaser">
                <div class="col-sm-6 col-md-4">
                    <div class="card cardwidth">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Facial Thread Lift</h5>
                            <p class="card-text">This treatment involves inserting threads under the skin to lift and
                                tighten sagging areas, such as the cheeks, jawline, and neck. It provides a subtle,
                                natural-looking lift and stimulates collagen production for long-lasting results.</p>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="card cardwidth">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Neck Thread Lift</h5>
                            <p class="card-text">Designed to address loose skin and aging signs in the neck, this
                                procedure lifts and tightens sagging skin while reducing the appearance of fine lines
                                and wrinkles.</p>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="card cardwidth">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Eyebrow and Eyelid <br> Lifting</h5>
                            <p class="card-text">Threads can also be used to lift the eyebrows and eyelids, giving you a
                                fresher, more youthful look. It’s a great option for those looking to enhance their eyes
                                without surgery.</p>
                        ...
                        <div class="card cardwidth1">
                            <div class="image" style="padding:1rem">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">I was so happy with my thread lift! The results were immediate,
                                        and over time, my skin felt firmer and smoother. The best part? No surgery!
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card cardwidth1">
                            <div class="image" style="padding:1rem">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">I had sagging skin around my neck that always bothered me. The
                                        thread lift at Kimaya Clinique made a huge difference, and I feel so much more
                                        confident now.”
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="card cardwidth1">
                            <div class="image" style="padding:1rem">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">The team at Kimaya explained everything clearly and made me
                                        feel comfortable throughout the process. My eyebrows have never looked this
                                        good!</p>
                                </div>
                            </div>
                            <div class="card-footer" style=" border-bottom-left-radius: 17px;
      border-bottom-right-radius: 17px;">
        ...
        <div class="container" id="faq">
            <div class="row">
                <div class="col-sm-6 col-md-6 ">
                    <img src="./image/th-1.webp" alt="faqimg" style="width:80%">
                </div>
                <div class="col-sm-6 col-md-6 ">
                    <div id="texts" style="white-space:nowrap;">
                        <img src="./images/star.webp" align="left" />
                    ...
                    <h5>Faq</h5>
                    <h2 style="font-weight:600">FAQs about Threads</h2>
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Results from thread lifts can last up to 1-2 years, depending on factors like age,
                                    skin type, and lifestyle. The threads dissolve naturally while boosting collagen
                                    production.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Local anesthesia is used, so the treatment is generally painless. You may experience
                                    mild discomfort during the procedure and some swelling or bruising afterward.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    You’ll notice an immediate lift after the treatment. Over the following months, your
                                    skin will continue to improve as collagen builds up, enhancing the results.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    There is minimal downtime, and most patients can return to their normal activities
                                    within a few days. Some mild swelling or bruising may occur, but it typically
