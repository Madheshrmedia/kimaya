            ...
            <div class="col-sm-6 col-md-4">
              <div class="card cardwidth" >
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Boost hair growth and strengthen hair follicles with our Tricell Hair Rejuvenation treatment. Using advanced cell-therapy techniques, we address thinning hair, hair loss, and scalp health to restore volume and vitality naturally.</p>
                ...
                <div class="col-sm-6 col-md-4">
                  <div class="card cardwidth" >
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Achieve a toned and sculpted body with our Tricell Body Sculpting treatment. Designed to target stubborn fat and reshape your body contours, this treatment is non-surgical, using advanced technology to firm, lift, and sculpt.</p>
